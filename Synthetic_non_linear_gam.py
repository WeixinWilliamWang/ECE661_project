...
RESULTS_DIR = "Results_non_linear_gam_gam"  # <== new output directory
...
for problem in problems:
  ...
  for super_run in range(num_super_runs_local):
    ...
    plt.tight_layout()
    plt.legend()      
    plt.savefig("Results_non_linear_gam_gam/%s_diffusion_prior.pdf" % problem)
    plt.close()
    ...
    for run in range(num_runs):
        ...
        envs.append(NonLinearBandit(Phi, theta, sigma=sigma, type='gam'))
